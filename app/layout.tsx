...
export const metadata: Metadata = {
  ...
  keywords: [
    "indoor golf Gainesville GA",
    "golf simulator Gainesville",
    "best indoor golf simulator Georgia",
    "golf simulator Hall County",
    "North Georgia indoor golf",
    "24/7 golf simulator",
    "indoor golf near me",
    "members golf club Gainesville GA",
    "golf simulator rental Gainesville",
    "corporate golf events Gainesville",
    "golf lessons Gainesville GA",
